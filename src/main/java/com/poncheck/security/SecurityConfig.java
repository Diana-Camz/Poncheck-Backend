    ...
    public SecurityFilterChain filterChain(
         ...
         http
                 ...
                 .authorizeHttpRequests(request -> request
                         ...
                         .requestMatchers(HttpMethod.POST,"/api/v1/products/", "/api/v1/products/{id}/active", "/api/v1/products/prices").hasAnyRole("ADMIN", "OWNER")
                         ...
                         .requestMatchers(HttpMethod.PUT, "/api/v1/business/{id}").hasAnyRole("OWNER", "ADMIN")
                         .requestMatchers("/api/v1/business/**").hasRole("ADMIN")
